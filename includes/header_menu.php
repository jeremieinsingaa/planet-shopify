                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   ...
                                   <a href="products.php#headphones" class="dropdown-item">Casque/Haut-parleurs</a>
                               </div>
                           
                       </li>
                       <li class="nav-item"><a href="index.php" class="nav-link">Offres</a></li>
                       <li class="nav-item"><a href="about.php" class="nav-link">À propos de nous</a></li>
                       <?php
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content"style="background-color:rgba(255,255,255,0.95)">
            ...
            <div class="modal-body">
              <form action="login_script.php" method="post">
                ...
                <div class="form-check">
                    ...
                    <label for="checkbox" class="form-check-label">Vérifier</label>
                </div>
            ...
            <div class="modal-footer">
              <p class="mr-auto">Nouvel utilisateur ? <a href="#signup" data-toggle="modal" data-dismiss="modal" >S'inscrire</a></p>
            ...
            <div class="modal-body">
              <form action="signup_script.php" method="post">
                ...
                <div class="form-check">
                    ...
                    <label for="checkbox" class="form-check-label">Accepter les termes et conditions</label>
                </div>
                <button type="submit" class="btn btn-primary btn-block" name="Submit">Sign Up</button>
              </form>
            </div>
            <div class="modal-footer">
              <p class="mr-auto">Déjà enregistré? <a href="#login"  data-toggle="modal" data-dismiss="modal">Login</a></p>
