...
?>
    ...
    <div id="content">
        <div id="bg" class=" ">
            ...
            <h1>Nous vendons du Bonheur :)</h1>
            <p>40 % de réduction sur les marques premium </p>
            <a href="products.php" class="btn btn-warning btn-lg text-white">Achetez maintenant</a>
            </div>
            </div>
        </div>
    </div>
    <div class="text-center pt-4 h3">
        * Soyez à la mode Hommes *
    </div>
