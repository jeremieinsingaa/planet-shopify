...
<head>
  ...
  <title>Planet Shopify | Site de magasin en ligne pour hommes</title>
...
<body style="overflow-x:hidden; padding-bottom:100px;">
    ...
    <div class="container mt-5 ">
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          <h3 class="text-warning pt-3 title">Qui nous sommes ?</h3>
          <hr />
          <img
        ...
        <div class="col-md-5 mt-3">
          <span class="text-warning pt-3">
            ...
            <h3>24h/24|7j/7| Assistance technique en direct 365 jours par an</h3>
          </span>
          <hr>
  ...
  <div class="container mt-3 d-flex justify-content-center card pb-3 col-md-6">
    ...
    <form class="col-md-12" action="https://formspree.io/EnterYourEmail" method="POST" name="_next">
      <h3 class="text-warning pt-3 title mx-auto">Formulaire de contact</h3>
